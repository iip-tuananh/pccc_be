...
{{--    </section>--}}
    ...
    <section class="faq-one" style="padding: 40px 0px">
        <div class="container">
            <div class="sec-title text-center wow fadeInUp animated" data-wow-duration="1500ms" data-wow-delay="000ms"
                style="visibility: visible; animation-duration: 1500ms; animation-delay: 0ms; animation-name: fadeInUp;">
                <h6 class="sec-title__tagline"><img src="/site/images/shapes/sec-title-s-1.png" alt="FAQS"
                        class="sec-title__img"> Văn hóa doanh nghiệp</h6>
                <h3 class="sec-title__title">Văn hóa doanh nghiệp tại Việt - Be</h3>
            </div>
            <div class="row gutter-y-30">
                <div class="col-lg-7">
                    <div class="faq-page__accordion firdip-accrodion wow fadeInUp animated" data-wow-duration="1500ms"
                        data-wow-delay="300ms" data-grp-name="firdip-accrodion"
                        style="visibility: visible; animation-duration: 1500ms; animation-delay: 300ms; animation-name: fadeInUp;">

                        @foreach ($workflow->content as $k => $wk)
                            <div class="accrodion {{ $k == 0 ? 'active' : '' }}">
                                <div class="accrodion-title">
                                    <h4 class="accrodion-title__text">{{ $wk['title'] }}<span
                ...
                <div class="col-lg-5">
                    <div class="faq-page__right">
                        <div class="faqs-two__thumb wow fadeInUp animated" data-wow-duration="1500ms"
